...
const COUNTRIES = {
  ...
  en: { id: 'en', label: 'Angleterre', flag: '🏴' },
  es: { id: 'es', label: 'Espagne', flag: '🇪🇸' },
  de: { id: 'de', label: 'Allemagne', flag: '🇩🇪' },
  it: { id: 'it', label: 'Italie', flag: '🇮🇹' },
  pt: { id: 'pt', label: 'Portugal', flag: '🇵🇹' },
  nl: { id: 'nl', label: 'Pays-Bas', flag: '🇳🇱' },
  be: { id: 'be', label: 'Belgique', flag: '🇧🇪' },
  tr: { id: 'tr', label: 'Turquie', flag: '🇹🇷' },
  br: { id: 'br', label: 'Brésil', flag: '🇧🇷' },
  ar: { id: 'ar', label: 'Argentine', flag: '🇦🇷' },
  co: { id: 'co', label: 'Colombie', flag: '🇨🇴' },
  uy: { id: 'uy', label: 'Uruguay', flag: '🇺🇾' },
  us: { id: 'us', label: 'États-Unis', flag: '🇺🇸' },
  mx: { id: 'mx', label: 'Mexique', flag: '🇲🇽' },
  ma: { id: 'ma', label: 'Maroc', flag: '🇲🇦' },
  sn: { id: 'sn', label: 'Sénégal', flag: '🇸🇳' },
  jp: { id: 'jp', label: 'Japon', flag: '🇯🇵' },
  kr: { id: 'kr', label: 'Corée du Sud', flag: '🇰🇷' },
};
